...
"""
#
# TODO: conditional posteriors should know about the parameters whose
# conditional posterior they represent
#
import numpy as np
...
class ConditionalPosterior(Probability):
    ...
    """
    def __init__(self, name, likelihoods=None, priors=None, params=None):
        """ConditionalPosterior

        Create the conditional posterior from a list of likelihoods and priors
        that depend on the parameters of interest.
        ...
        likelihoods : iterable
            List of likelihoods that depend on the parameters of interest. 

        priors : iterable
            List of priors that depend on the parameters of interest. 
        """
        super(ConditionalPosterior, self).__init__(name, params=params)
    ...
    def log_prob(self):
        """Total log probability generated by the prior and likelihood factors.
        """
        self.update()
        log_p = 0.
        for p in self:
...
class PosteriorCoordinates(ConditionalPosterior):
    ...
    def update_forces(self):
        """Update Cartesian gradient of the factors with respect to the
        Cartesian coordinates. The gradient can be used to guide a sampler for
        generating conformations from the conditional posterior. 
        """
        self.update()
